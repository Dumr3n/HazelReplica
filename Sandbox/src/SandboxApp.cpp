...
public:
		...
		: Layer("Example"), m_CameraController(1280.0f / 720.0f)
	{
		...
		indexBuffer = Hazel::IndexBuffer::Create(indices, sizeof(indices) / sizeof(indices[0]));
		...
		auto textureShader = m_ShaderLibrary.Load(std::string(ASSET_PATH) + "/shaders/Texture.glsl");

		m_Texture = Hazel::Texture2D::Create(std::string(ASSET_PATH) + "/textures/Checkerboard.png");
		m_ChernoLogoTexture = Hazel::Texture2D::Create(std::string(ASSET_PATH) + "/textures/ChernoLogo.png");
